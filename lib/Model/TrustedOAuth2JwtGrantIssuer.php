...
class TrustedOAuth2JwtGrantIssuer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'issuer' => 'string',
        'publicKey' => '\Scottbass3\Hydra\Client\Model\TrustedOAuth2JwtGrantJsonWebKey',
        'scope' => 'string[]',
        'subject' => 'string'
    ];
    ...
    */
     ...
     * Gets publicKey
     *
     * @return \Scottbass3\Hydra\Client\Model\TrustedOAuth2JwtGrantJsonWebKey|null
     */
     ...
     * Sets publicKey
     *
     * @param \Scottbass3\Hydra\Client\Model\TrustedOAuth2JwtGrantJsonWebKey|null $publicKey publicKey
     *
     * @return self
     */
