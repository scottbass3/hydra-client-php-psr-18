...
class OAuth2ConsentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'amr' => 'string[]',
        'challenge' => 'string',
        'client' => '\Scottbass3\Hydra\Client\Model\OAuth2Client',
        'consentRequestId' => 'string',
        'context' => 'mixed',
        'loginChallenge' => 'string',
        'loginSessionId' => 'string',
        'oidcContext' => '\Scottbass3\Hydra\Client\Model\OAuth2ConsentRequestOpenIDConnectContext',
        'requestUrl' => 'string',
    ...
    */
     ...
     * Gets client
     *
     * @return \Scottbass3\Hydra\Client\Model\OAuth2Client|null
     */
     ...
     * Sets client
     *
     * @param \Scottbass3\Hydra\Client\Model\OAuth2Client|null $client client
     *
     * @return self
     */
     ...
     * Gets oidcContext
     *
     * @return \Scottbass3\Hydra\Client\Model\OAuth2ConsentRequestOpenIDConnectContext|null
     */
     ...
     * Sets oidcContext
     *
     * @param \Scottbass3\Hydra\Client\Model\OAuth2ConsentRequestOpenIDConnectContext|null $oidcContext oidcContext
     *
     * @return self
     */
