...
namespace Scottbass3\Hydra\Client\Model;
...
class OAuth2ConsentSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'consentRequest' => '\Scottbass3\Hydra\Client\Model\OAuth2ConsentRequest',
        ...
        'remember' => 'bool',
        'rememberFor' => 'int',
        'session' => '\Scottbass3\Hydra\Client\Model\AcceptOAuth2ConsentRequestSession'
    ];
    ...
    */
     ...
     * Gets consentRequest
     *
     * @return \Scottbass3\Hydra\Client\Model\OAuth2ConsentRequest|null
     */
     ...
     * Sets consentRequest
     *
     * @param \Scottbass3\Hydra\Client\Model\OAuth2ConsentRequest|null $consentRequest consentRequest
     *
     * @return self
     */
     ...
     * Gets session
     *
     * @return \Scottbass3\Hydra\Client\Model\AcceptOAuth2ConsentRequestSession|null
     */
     ...
     * Sets session
     *
     * @param \Scottbass3\Hydra\Client\Model\AcceptOAuth2ConsentRequestSession|null $session session
     *
     * @return self
     */
